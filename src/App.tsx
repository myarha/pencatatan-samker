                      ...
                      <div className="space-y-3 px-1">
                        {filteredTransactions.map((trx) => (
                          <div key={trx.id} className="bg-white border-2 border-slate-300 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                            {/* SSPD Header Style */}
                            <div className="bg-slate-100 text-slate-800 px-3 py-2 flex justify-between items-center border-b border-slate-200">
                              <div className="flex flex-col">
                                <span className="text-[8px] font-black tracking-[0.2em] leading-none opacity-60 text-slate-500">SURAT SETORAN PAJAK DAERAH</span>
                                <span className="text-[11px] font-black tracking-widest leading-tight text-slate-800">SSPD - {trx.tanggalTetap?.split('-')[2] || '2025'}</span>
                              </div>
                              <div className="flex items-center gap-1.5 ml-1 border-l border-slate-300 pl-2">
                                {trx.imageData && (
                                  <button 
                            ...
                            <div className="flex flex-col">
                              <div className="flex border-b border-slate-200">
                                <div className="w-24 bg-slate-50 px-2.5 py-1.5 text-[8px] font-black text-slate-500 uppercase border-r border-slate-200 flex items-center">NOMOR POLISI</div>
                                <div className="flex-1 px-3 py-1.5 text-sm font-black text-slate-900 tracking-wider font-mono">{trx.nomorPolisi}</div>
                              </div>
